...
-- IDs verified against wowhead.com/classic and wowhead.com/tbc.
...
WW.DATA["DRUID"] = {
    ...
    -- Classic T1: Cenarion Raiment (MC)
    ...
    -- Classic T2: Stormrage Raiment (BWL)
    ...
    S("T3 - Dreamwalker",       "Head",     "Dreamwalker Headpiece",         22488),
    S("T3 - Dreamwalker",       "Shoulder", "Dreamwalker Spaulders",         22489),
    S("T3 - Dreamwalker",       "Chest",    "Dreamwalker Tunic",             22486),
    S("T3 - Dreamwalker",       "Hands",    "Dreamwalker Handguards",        22485),
    S("T3 - Dreamwalker",       "Legs",     "Dreamwalker Legguards",         22487),
    S("T3 - Dreamwalker",       "Feet",     "Dreamwalker Boots",             22490),
    S("T3 - Dreamwalker",       "Waist",    "Dreamwalker Girdle",            22491),
    S("T3 - Dreamwalker",       "Wrist",    "Dreamwalker Wristguards",       22492),
    ...
    -- PvP S1: Gladiator's Dragonhide (feral) / Wyrmhide (resto)
...
WW.DATA["HUNTER"] = {
    ...
    -- Classic T1: Giantstalker's Armor (MC)
    S("T1 - Giantstalker",      "Head",     "Giantstalker's Helmet",         16852),
    S("T1 - Giantstalker",      "Shoulder", "Giantstalker's Epaulets",       16848),
    S("T1 - Giantstalker",      "Chest",    "Giantstalker's Breastplate",    16847),
    S("T1 - Giantstalker",      "Hands",    "Giantstalker's Gloves",         16850),
    S("T1 - Giantstalker",      "Legs",     "Giantstalker's Leggings",       16849),
    S("T1 - Giantstalker",      "Feet",     "Giantstalker's Boots",          16851),
    S("T1 - Giantstalker",      "Waist",    "Giantstalker's Belt",           16853),
    S("T1 - Giantstalker",      "Wrist",    "Giantstalker's Bracers",        16854),

    -- Classic T2: Dragonstalker's Armor (BWL)
    ...
    -- PvP S1: Gladiator's Chain Armor
...
WW.DATA["MAGE"] = {
    ...
    -- Classic T1: Arcanist Regalia (MC)
    ...
    -- Classic T2: Netherwind Regalia (BWL)
    S("T2 - Netherwind",        "Head",     "Netherwind Crown",              16912),
    S("T2 - Netherwind",        "Shoulder", "Netherwind Mantle",             16914),
    S("T2 - Netherwind",        "Chest",    "Netherwind Robes",              16915),
    S("T2 - Netherwind",        "Hands",    "Netherwind Gloves",             16911),
    S("T2 - Netherwind",        "Legs",     "Netherwind Pants",              16913),
    S("T2 - Netherwind",        "Feet",     "Netherwind Boots",              16909),
    S("T2 - Netherwind",        "Waist",    "Netherwind Belt",               16908),
    S("T2 - Netherwind",        "Wrist",    "Netherwind Bindings",           16910),
...
WW.DATA["PALADIN"] = {
    ...
    -- Classic T1: Lawbringer Armor (MC)
    S("T1 - Lawbringer",        "Head",     "Lawbringer Helm",               16921),
    S("T1 - Lawbringer",        "Shoulder", "Lawbringer Spaulders",          16922),
    S("T1 - Lawbringer",        "Chest",    "Lawbringer Chestguard",         16925),
    S("T1 - Lawbringer",        "Hands",    "Lawbringer Gauntlets",          16923),
    S("T1 - Lawbringer",        "Legs",     "Lawbringer Legplates",          16924),
    S("T1 - Lawbringer",        "Feet",     "Lawbringer Boots",              16926),
    S("T1 - Lawbringer",        "Waist",    "Lawbringer Belt",               16919),
    S("T1 - Lawbringer",        "Wrist",    "Lawbringer Bracers",            16920),

    -- Classic T2: Judgement Armor (BWL)
    ...
    -- PvP S1: Gladiator's Aegis (Paladin Plate)
    S("PvP S1 - Aegis",         "Head",     "Gladiator's Lamellar Helm",     28102),
    S("PvP S1 - Aegis",         "Shoulder", "Gladiator's Lamellar Shoulders", 28104),
    S("PvP S1 - Aegis",         "Chest",    "Gladiator's Lamellar Chestpiece", 28105),
    S("PvP S1 - Aegis",         "Hands",    "Gladiator's Lamellar Gauntlets", 28101),
    S("PvP S1 - Aegis",         "Legs",     "Gladiator's Lamellar Legguards", 28103),

    -- PvP S2: Merciless Gladiator's Aegis
    S("PvP S2 - Aegis",         "Head",     "Merciless Gladiator's Lamellar Helm", 32012),
    S("PvP S2 - Aegis",         "Shoulder", "Merciless Gladiator's Lamellar Shoulders", 32014),
    S("PvP S2 - Aegis",         "Chest",    "Merciless Gladiator's Lamellar Chestpiece", 32015),
    S("PvP S2 - Aegis",         "Hands",    "Merciless Gladiator's Lamellar Gauntlets", 32011),
    S("PvP S2 - Aegis",         "Legs",     "Merciless Gladiator's Lamellar Legguards", 32013),

    -- PvP S3: Vengeful Gladiator's Aegis
    S("PvP S3 - Aegis",         "Head",     "Vengeful Gladiator's Lamellar Helm", 33739),
    S("PvP S3 - Aegis",         "Shoulder", "Vengeful Gladiator's Lamellar Shoulders", 33741),
    S("PvP S3 - Aegis",         "Chest",    "Vengeful Gladiator's Lamellar Chestpiece", 33742),
    S("PvP S3 - Aegis",         "Hands",    "Vengeful Gladiator's Lamellar Gauntlets", 33738),
    S("PvP S3 - Aegis",         "Legs",     "Vengeful Gladiator's Lamellar Legguards", 33740),

    -- PvP S4: Brutal Gladiator's Aegis
    S("PvP S4 - Aegis",         "Head",     "Brutal Gladiator's Lamellar Helm", 35016),
    S("PvP S4 - Aegis",         "Shoulder", "Brutal Gladiator's Lamellar Shoulders", 35018),
    S("PvP S4 - Aegis",         "Chest",    "Brutal Gladiator's Lamellar Chestpiece", 35019),
    S("PvP S4 - Aegis",         "Hands",    "Brutal Gladiator's Lamellar Gauntlets", 35015),
    S("PvP S4 - Aegis",         "Legs",     "Brutal Gladiator's Lamellar Legguards", 35017),
}
...
WW.DATA["PRIEST"] = {
    ...
    S("Pre-Raid - Devout",      "Chest",    "Devout Robe",                   10790),
    ...
    -- Classic T1: Vestments of Prophecy (MC)
    S("T1 - Prophecy",          "Head",     "Circlet of Prophecy",           16813),
    S("T1 - Prophecy",          "Shoulder", "Mantle of Prophecy",            16816),
    S("T1 - Prophecy",          "Chest",    "Robes of the Exalted",          16814),
    S("T1 - Prophecy",          "Hands",    "Gloves of Prophecy",            16812),
    S("T1 - Prophecy",          "Legs",     "Pants of Prophecy",             16815),
    S("T1 - Prophecy",          "Feet",     "Boots of Prophecy",             16811),
    S("T1 - Prophecy",          "Waist",    "Sash of Prophecy",              16817),
    S("T1 - Prophecy",          "Wrist",    "Bracelets of Prophecy",         16818),

    -- Classic T2: Transcendence (BWL)
    S("T2 - Transcendence",     "Head",     "Transcendence Circlet",         16820),
    S("T2 - Transcendence",     "Shoulder", "Transcendence Mantle",          16819),
    S("T2 - Transcendence",     "Chest",    "Robes of Transcendence",        16823),
    S("T2 - Transcendence",     "Hands",    "Transcendence Gloves",          16821),
    S("T2 - Transcendence",     "Legs",     "Transcendence Legguards",       16822),
    S("T2 - Transcendence",     "Feet",     "Transcendence Boots",           16826),
    S("T2 - Transcendence",     "Waist",    "Transcendence Girdle",          16824),
    S("T2 - Transcendence",     "Wrist",    "Transcendence Bracers",         16825),
    ...
    -- PvP S1: Gladiator's Mooncloth / Satin
...
WW.DATA["ROGUE"] = {
    ...
    -- Classic T1: Nightslayer Armor (MC)
    ...
    -- Classic T2: Bloodfang Armor (BWL)
    S("T2 - Bloodfang",         "Head",     "Bloodfang Hood",                16869),
    S("T2 - Bloodfang",         "Shoulder", "Bloodfang Spaulders",           16871),
    S("T2 - Bloodfang",         "Chest",    "Bloodfang Chestpiece",          16868),
    S("T2 - Bloodfang",         "Hands",    "Bloodfang Gloves",              16870),
    S("T2 - Bloodfang",         "Legs",     "Bloodfang Pants",               16872),
    S("T2 - Bloodfang",         "Feet",     "Bloodfang Boots",               16873),
    S("T2 - Bloodfang",         "Waist",    "Bloodfang Belt",                16874),
    S("T2 - Bloodfang",         "Wrist",    "Bloodfang Bracers",             16875),
    ...
    -- PvP S1: Gladiator's Leather / Wyrmhide (combat/sub)
    S("PvP S1 - Leather",       "Head",     "Gladiator's Wyrmhide Helm",     28137),
    S("PvP S1 - Leather",       "Shoulder", "Gladiator's Wyrmhide Spaulders", 28139),
    S("PvP S1 - Leather",       "Chest",    "Gladiator's Wyrmhide Tunic",    28140),
    S("PvP S1 - Leather",       "Hands",    "Gladiator's Wyrmhide Gloves",   28136),
    S("PvP S1 - Leather",       "Legs",     "Gladiator's Wyrmhide Legguards", 28138),

    -- PvP S2: Merciless Gladiator's Leather
    S("PvP S2 - Leather",       "Head",     "Merciless Gladiator's Wyrmhide Helm", 32017),
    S("PvP S2 - Leather",       "Shoulder", "Merciless Gladiator's Wyrmhide Spaulders", 32019),
    S("PvP S2 - Leather",       "Chest",    "Merciless Gladiator's Wyrmhide Tunic", 32020),
    S("PvP S2 - Leather",       "Hands",    "Merciless Gladiator's Wyrmhide Gloves", 32016),
    S("PvP S2 - Leather",       "Legs",     "Merciless Gladiator's Wyrmhide Legguards", 32018),

    -- PvP S3: Vengeful Gladiator's Leather
    S("PvP S3 - Leather",       "Head",     "Vengeful Gladiator's Wyrmhide Helm", 33744),
    S("PvP S3 - Leather",       "Shoulder", "Vengeful Gladiator's Wyrmhide Spaulders", 33746),
    S("PvP S3 - Leather",       "Chest",    "Vengeful Gladiator's Wyrmhide Tunic", 33747),
    S("PvP S3 - Leather",       "Hands",    "Vengeful Gladiator's Wyrmhide Gloves", 33743),
    S("PvP S3 - Leather",       "Legs",     "Vengeful Gladiator's Wyrmhide Legguards", 33745),

    -- PvP S4: Brutal Gladiator's Leather
    S("PvP S4 - Leather",       "Head",     "Brutal Gladiator's Wyrmhide Helm", 35021),
    S("PvP S4 - Leather",       "Shoulder", "Brutal Gladiator's Wyrmhide Spaulders", 35023),
    S("PvP S4 - Leather",       "Chest",    "Brutal Gladiator's Wyrmhide Tunic", 35024),
    S("PvP S4 - Leather",       "Hands",    "Brutal Gladiator's Wyrmhide Gloves", 35020),
    S("PvP S4 - Leather",       "Legs",     "Brutal Gladiator's Wyrmhide Legguards", 35022),
}
...
-- ============================================================
WW.DATA["SHAMAN"] = {
    -- Classic T1: The Elements (MC)
    S("T1 - The Elements",      "Head",     "Earthfury Helmet",              16840),
    S("T1 - The Elements",      "Shoulder", "Earthfury Epaulets",            16839),
    S("T1 - The Elements",      "Chest",    "Earthfury Vestments",           16843),
    S("T1 - The Elements",      "Hands",    "Earthfury Gauntlets",           16841),
    S("T1 - The Elements",      "Legs",     "Earthfury Legguards",           16844),
    S("T1 - The Elements",      "Feet",     "Earthfury Boots",               16837),
    S("T1 - The Elements",      "Waist",    "Earthfury Belt",                16838),
    S("T1 - The Elements",      "Wrist",    "Earthfury Bracers",             16842),

    -- Classic T2: Ten Storms (BWL)
    ...
    -- TBC T4: Cyclone (Kara/Gruul/Mag)
    S("T4 - Cyclone",           "Head",     "Cyclone Helm",                  29040),
    S("T4 - Cyclone",           "Shoulder", "Cyclone Shoulderplates",        29043),
    S("T4 - Cyclone",           "Chest",    "Cyclone Breastplate",           29038),
    S("T4 - Cyclone",           "Hands",    "Cyclone Gauntlets",             29039),
    S("T4 - Cyclone",           "Legs",     "Cyclone War-Kilt",              29042),
    ...
    -- PvP S1: Gladiator's Linked Armor
...
WW.DATA["WARLOCK"] = {
    ...
    -- Classic T1: Felheart Raiment (MC)
    ...
    -- Classic T2: Nemesis Raiment (BWL)
    S("T2 - Nemesis",           "Head",     "Nemesis Skullcap",              16901),
    S("T2 - Nemesis",           "Shoulder", "Nemesis Mantle",                16900),
    S("T2 - Nemesis",           "Chest",    "Nemesis Robes",                 16903),
    S("T2 - Nemesis",           "Hands",    "Nemesis Gloves",                16899),
    S("T2 - Nemesis",           "Legs",     "Nemesis Leggings",              16902),
    S("T2 - Nemesis",           "Feet",     "Nemesis Boots",                 16896),
    S("T2 - Nemesis",           "Waist",    "Nemesis Belt",                  16897),
    S("T2 - Nemesis",           "Wrist",    "Nemesis Bracers",               16898),
...
WW.DATA["WARRIOR"] = {
    ...
    -- Classic T1: Battlegear of Might (MC)
    S("T1 - Might",             "Head",     "Helm of Might",                 16866),
    S("T1 - Might",             "Shoulder", "Pauldrons of Might",            16867),
    S("T1 - Might",             "Chest",    "Breastplate of Might",          16861),
    S("T1 - Might",             "Hands",    "Gauntlets of Might",            16864),
    S("T1 - Might",             "Legs",     "Legplates of Might",            16863),
    S("T1 - Might",             "Feet",     "Sabatons of Might",             16862),
    S("T1 - Might",             "Waist",    "Belt of Might",                 16865),
    S("T1 - Might",             "Wrist",    "Bracers of Might",              16857),

    -- Classic T2: Battlegear of Wrath (BWL)
